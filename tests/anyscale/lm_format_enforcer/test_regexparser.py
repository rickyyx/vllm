...
def _test_regex_parsing_with_string(string: str,
    ...
    assert_parser_with_string(string,
                              parser,
                              expect_success,
...
def test_parsing_exact_string():
    _test_regex_parsing_with_string(string='abc123',
                                    regex='abc123',
                                    expect_success=True)


def test_parsing_exact_string_failure():
    _test_regex_parsing_with_string(string='abc124',
                                    regex='abc123',
...
def test_parsing_letter_options():
    for letter in 'cdefghif':
        ...
        _test_regex_parsing_with_string(string=f'ab{letter}123',
...
def test_parsing_repeat():
    for num_repeats in range(20):
        ...
        _test_regex_parsing_with_string(string=f'ab{"c" * num_repeats}123',
                                        regex='abc+123',
                                        expect_success=expect_success)
...
def test_increasing_alphabet():
    ...
    _test_regex_parsing_with_string('abΣ',
                                    any_regex,
                                    True,

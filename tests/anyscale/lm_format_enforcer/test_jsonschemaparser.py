...
class SampleModel(BaseModel):
    ...
    list_of_strings: Optional[List[str]] = Field(None,
                                                 min_length=2,
                                                 max_length=3)
...
def test_minimal():
    test_string = '{"num":1}'
    _test_json_schema_parsing_with_string(test_string,
...
def test_boolean_field():
    _test_json_schema_parsing_with_string('{"num":1,"true_or_false":false}',
                                          SampleModel.model_json_schema(),
                                          True)
    _test_json_schema_parsing_with_string('{"num":1,"true_or_false":true}',
                                          SampleModel.model_json_schema(),
                                          True)
    _test_json_schema_parsing_with_string('{"num":1,"true_or_false": true}',
                                          SampleModel.model_json_schema(),
                                          True)
    _test_json_schema_parsing_with_string('{"num":1,"true_or_false":falsy}',
                                          SampleModel.model_json_schema(),
                                          False)
...
def test_unspecified_dict():
    ...
    _test_json_schema_parsing_with_string('{"num":1,"d":{"k":"v"}}',
                                          DictModel.model_json_schema(), True)
...
def test_unspecified_list():
    ...
    _test_json_schema_parsing_with_string('{"num":1,"l":[1,2,3,"b"]}',
                                          DictModel.model_json_schema(), True)
...
def test_list_length_limitations():
    ...
    _test_json_schema_parsing_with_string(no_strings,
                                          SampleModel.model_json_schema(),
                                          False)
    one_string = '{"num":1,"list_of_strings":["a"]}'
    _test_json_schema_parsing_with_string(one_string,
                                          SampleModel.model_json_schema(),
                                          False)
    two_strings = '{"num":1,"list_of_strings":["a", "b"]}'
    _test_json_schema_parsing_with_string(two_strings,
                                          SampleModel.model_json_schema(),
                                          True)
    three_strings = '{"num":1,"list_of_strings":["a","b","c"]}'
    _test_json_schema_parsing_with_string(three_strings,
                                          SampleModel.model_json_schema(),
                                          True)
    four_strings = '{"num":1,"list_of_strings":["a","b","c","d"]}'
    _test_json_schema_parsing_with_string(four_strings,
                                          SampleModel.model_json_schema(),
                                          False)
    ...
    _test_json_schema_parsing_with_string(no_strings,
                                          EmptyListOKModel.model_json_schema(),
                                          True)
    _test_json_schema_parsing_with_string(one_string,
                                          EmptyListOKModel.model_json_schema(),
                                          True)
    ...
    _test_json_schema_parsing_with_string(
        no_strings, ListOfExactlyOneModel.model_json_schema(), False)
    _test_json_schema_parsing_with_string(
        one_string, ListOfExactlyOneModel.model_json_schema(), True)
    _test_json_schema_parsing_with_string(
        two_strings, ListOfExactlyOneModel.model_json_schema(), False)
    ...
    _test_json_schema_parsing_with_string(
        no_strings, ListOfNoMinLengthModel.model_json_schema(), True)
    _test_json_schema_parsing_with_string(
        one_string, ListOfNoMinLengthModel.model_json_schema(), True)
    _test_json_schema_parsing_with_string(
        two_strings, ListOfNoMinLengthModel.model_json_schema(), False)
...
def test_long_json_object():
    ...
    _test_json_schema_parsing_with_string(json_text,
                                          None,
                                          True,
...
def test_union():
    ...
    _test_json_schema_parsing_with_string('{"key": 1}',
                                          SchemaWithUnion.model_json_schema(),
                                          True)
    _test_json_schema_parsing_with_string('{"key": "a"}',
                                          SchemaWithUnion.model_json_schema(),
                                          True)
    _test_json_schema_parsing_with_string('{"key": 1.2}',
                                          SchemaWithUnion.model_json_schema(),
                                          False)
    _test_json_schema_parsing_with_string('{"key": false}',
                                          SchemaWithUnion.model_json_schema(),
                                          False)
...
def test_more_string_constraints():
    for str_length in range(20):
        ...
        _test_json_schema_parsing_with_string(
            test_string, StringConstraints.model_json_schema(), expect_sucess)
    ...
    for k, v in {
        ...
        for val in v:
            print(val)
            _test_json_schema_parsing_with_string(
                f'{{"{k}": "{val}"}}', StringConstraints.model_json_schema(),
                True)
    ...
    for k, v in {
        ...
        _test_json_schema_parsing_with_string(
            f'{{"{k}": "{v}"}}', StringConstraints.model_json_schema(), False)
...
def test_string_pattern_requirement():
    ...
    _test_json_schema_parsing_with_string(
        '{"str_field": "ababab"}', SchemaWithPattern.model_json_schema(), True)
    _test_json_schema_parsing_with_string(
        '{"str_field": "abc"}', SchemaWithPattern.model_json_schema(), False)
...
def test_phone_number_in_string():
    ...
    _test_json_schema_parsing_with_string(
        '{"name": "John", "phone": "(312)011-2444"}',
        ContactInfo.model_json_schema(), True)
    _test_json_schema_parsing_with_string(
        '{"name": "John", "phone": "312-011-2444"}',
        ContactInfo.model_json_schema(), False)
...
def test_union_typed_arrays():
    ...
    _test_json_schema_parsing_with_string(
        '{"fruits": [{"apple_type": 1}, {"apple_type": 2}] }',
        FruitsSchema.model_json_schema(), True)
    _test_json_schema_parsing_with_string(
        '{"fruits": [{"apple_type": 1}, {"is_ripe": true}] }',
        FruitsSchema.model_json_schema(), True)
    _test_json_schema_parsing_with_string(
        '{"fruits": [{"apple_type": 1, "is_ripe": true}] }',
        FruitsSchema.model_json_schema(), False)
...
def test_comma_cannot_start_list():
    ...
    _test_json_schema_parsing_with_string(output_ok,
                                          FlightRoute.model_json_schema(),
                                          True)
    _test_json_schema_parsing_with_string(output_notok,
                                          FlightRoute.model_json_schema(),
                                          False)

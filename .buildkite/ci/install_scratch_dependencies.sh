...
# support cuda 121.
sudo apt-get install g++-11 numactl gdb make emacs libgflags-dev cmake build-essential pkg-config libgoogle-perftools-dev nlohmann-json3-dev libre2-dev -y
